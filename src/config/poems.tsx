export const poems = [
    ...
    { date: '2025-02-17', content: 'Sur le chemin bordé de brume,\nChaque pas résonne en écho lointain.\nMais ton rire, au loin qui s’allume,\nFait fleurir l’espoir au creux du matin.' },
